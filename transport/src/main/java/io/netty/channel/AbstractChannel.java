...
public abstract class AbstractChannel extends DefaultAttributeMap implements Channel {
    ...
    protected AbstractChannel(Channel parent, ChannelId id) {
        /*
            NioServerSocketChannel初始化6:相关参数赋值
                客户端的Unsafe是AbstractNioByteChannel.NioByteUnsafe的实例,而服务端的Unsafe是
                AbstractNioMessageChannel.AbstractNioUnsafe的实例.
         */
        this.parent = parent;
        this.id = id;
        unsafe = newUnsafe();
        // NioServerSocketChannel初始化8:使用的是DefaultChannelPipeline的实例
        pipeline = newChannelPipeline();
    }
    ...
    protected DefaultChannelPipeline newChannelPipeline() {
        // ChannelPipeline初始化1:使用当前的Channel,就是前面实例化的NioSocketChannel或NioServerSocketChannel
